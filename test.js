...
//var citys=new Array("alidiqu","benxi","sansha","sanya","xinganmeng","hainanzhou","jixi","dandong","liangshanzhou","qitaihe","baicheng","guoluozhou","yichunshi","mudanjiang","lijiang","meizhou");
//var citys=new Array("daxinganlingdiqu","huangnanzhou","tachengdiqu","changdudiqu","liaoyuan","haimen","anshun","chuxiongzhou","diqingzhou","shanghai","shuangyashan","shenzhen","yuxi","xilinguolemeng");
//var citys=new Array("jiamusi","yushuzhou","heyuan","changchun","abazhou","linzhidiqu","qiqihaer","zhoushan","huizhou","wenshanzhou","jincheng","yanbianzhou","haixizhou","xingtai","rongcheng","rikazediqu");
//var citys=new Array("hulunbeier","shenyang","haikou","qiandongnanzhou","zhangye","honghezhou","fushun","zhongwei","nanping","naqudiqu","shijiazhuang","jilin","bijie","wulanchabu","zhuhai","anshan","dingxi");
//var citys=new Array("shanwei","chaoyang","sanming","siping","changshu","dalizhou","guyuan","yancheng","yantai","xishuangbannazhou","longnan","zunyi","alashanmeng","sanmenxia","wuwei","nantong","zhongshan");
//var citys=new Array("qingyuan","handan","bazhong","weihai","jinchang","puer","tieling","eerduosi","yulinshi","shannandiqu","baoding","suihua","taicang","longyan","enshizhou","liaoyang","jieyang");
//var citys=new Array("qiannanzhou","lasa","puyang","panzhihua","tongliao","neijiang","jiuquan","xinyang","rushan","ankang","zhangzhou","qujing","aletaidiqu","zhumadian","chaozhou","nujiangzhou","anyang","kunshan","dongguan","gannanzhou","shangluo","maoming","wuhai","shantou","ganzizhou","guiyang","yulin","jiayuguan","haerbin","tongchuan","wafangdian");
//var citys=new Array("shaoguan","hamidiqu","tianshui","shuozhou","loudi","luzhou","zhangjiakou","wendeng","qingdao","bayannaoer","xiaogan","zhanjiang","jingmen","jiangmen","guangzhou","ningbo","yunfu","zhaoqing","zhangjiajie","daqing","jiaozuo","yueyang","yangjiang","yangquan","shiyan","yichang","chifeng","kunming","wuxi","luoyang","jingdezhen");
//var citys=new Array("changzhi","zhangjiagang","luan","xianning","linxiazhou","pingxiang","xinxiang","chongqing","foshan","hechi","meishan","huangshan","guigang","taiyuan","qingyang","changde","nanning","beihai","chongzuo","yingkou","yibin","panjin","lincang","xining","xiangxizhou","xiamen","penglai","qianxinanzhou","wuzhong","heihe","pingdingshan");
//var citys=new Array("baoshan","liupanshui","chengde","haidongdiqu","lvliang","langfang","zhengzhou","jiaonan","hebi","wuzhou","yinchuan","nanchang","hezhou","zhoukou","chenzhou","dehongzhou","jinzhong","hetiandiqu","fuzhou","fangchenggang","xuchang","hengyang","luohe","jiaozhou","jiangyin","huaian","suizhou","qinzhou","hanzhong","pingliang","zhuzhou");
//var citys=new Array("tongrendiqu","bozhou","nanyang","songyuan","xinyu","yaan","quanzhou","akesudiqu","suzhou","guangan","baiyin","taizhoushi","yiyang","dalian","suining","zhaotong","changsha","shizuishan","baoji","zhaoyuan","kuerle","wujiang","liuzhou","jiujiang","hegang","tulufandiqu","jimo","xiangtan","lanzhou","jingzhou","changzhou","huludao");
//var citys=new Array("guangyuan","nanchong","yichun","yongzhou","anqing","guilin","putian","lishui","ziyang","zibo","wuhan","heze","yixing","datong","jinhua","huaihua","kaifeng","rizhao","hengshui","lianyungang","yingtan","chengdu","baise","jiaxing","huangshi","quzhou","leshan","huanggang","jinzhou","tonghua","laibin","shangqiu","xianyang","jian");
//var citys=new Array("pingdu","weifang","weinan","laizhou","ganzhou","cangzhou","fuxin","dongying","shaoyang","linyi","beijing","ezhou","dazhou","laixi","fuzhoushi","jinan","shouguang","ningde","yanan","jining","fuyang","shangrao","xiangyang","zaozhuang","qinhuangdao","zhangqiu","yangzhou","suqian","xinzhou","linfen","boertala","yiwu","nanjing");
//var citys=new Array("jintan","wuhu","xuzhou","wenzhou","tongling","linan","taian","chizhou","binzhou","mianyang","zhenjiang","hefei","taizhou","yuncheng","huainan","baishan","chuzhou","deyang","huaibei","maanshan","laiwu","bengbu","liyang","tangshan","jurong","fuyangshi","huzhou","xuancheng","tianjin","suzhoushi","yilihasakezhou","xian","dezhou");
//var citys=new Array("zigong","liaocheng","baotou","kelamayi","huhehaote","shaoxing","hangzhou","changjizhou","kezhou","wulumuqi","wujiaqu","shihezi","kashediqu");
